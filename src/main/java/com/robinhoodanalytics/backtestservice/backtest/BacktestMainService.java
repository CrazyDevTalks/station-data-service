...
public interface BacktestMainService {
    ...
    BacktestMainServiceImpl.BacktestSummary getMeanReversionResults(String symbol, Date from, Date to, BigDecimal deviation, int shortTerm, int longTerm) throws Exception;
